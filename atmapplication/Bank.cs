...
namespace atmapplication
{
    ...
    class ATM
    {
        ...
        public usrDetails[] usr = new usrDetails[6];

        static string ATM_ID = "SBIX080283";
        static string ATM_LOC ="XXXXX";

        public ATM()
        { 
            usr[0] = new usrDetails(1234, "SBPxxx1234", "Savings", "AAAAA", 40000, 1122);
            usr[1] = new usrDetails(1111, "ICICxx8690", "Current", "BBBBB", 15000, 1111);
            usr[2] = new usrDetails(2222, "HDFCxx8690", "Savings", "SSSSS", 45000, 2222);
            usr[3] = new usrDetails(3333, "ICICxx8690", "Current", "FFFFFF", 15000, 3333);
            usr[4] = new usrDetails(4444, "HDFCxx8690", "Savings", "TTTT", 50000, 4444);
            usr[5] = new usrDetails(5555, "ICICxx8690", "Current", "KDKS", 65000, 5555);  
        } 
    ...
    class Start
    {
        ...
        public static void header()
        {
            Console.Clear();
            Console.WriteLine("\n\n\n\n\t\t====================================");
            Console.WriteLine(mt + "State Bank of INDIA");
            Console.WriteLine("\t\t====================================");
        }
